	...
	<body>
		<%
			try {
				...
				String insert = "INSERT INTO employees(ssn,firstname,lastname,username,passwor) VALUES (?,?,?,?,?)";
				...
				String ssn2 = request.getParameter("ssn");
				String insert2 = "INSERT INTO customerRepresentatives(ssn) VALUES (?)";
