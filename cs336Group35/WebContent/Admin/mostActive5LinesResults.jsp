...
<title>5 Most Active Transit Lines</title>
</head>
<body>
	...
	<%
		...
		try {
			...
			String str = "SELECT r.transitLine as \"5 most active transit lines\" FROM reservations r GROUP BY r.transitLine order by count(*) desc limit 5;";
			...
			while (result.next()) {
				...
				out.print(result.getString("5 most active transit lines"));
				out.print("</td>");
