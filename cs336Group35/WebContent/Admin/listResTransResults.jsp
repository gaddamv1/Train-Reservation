...
<title>List of Res by Trans Results</title>
</head>
<body>
	<%
		...
		try {
			...
			String entity = request.getParameter("tLineRes");
			//Make a SELECT query from the sells table with the price range specified by the 'price' parameter at the index.jsp
			String str = "SELECT r.reservationNum, r.resDate FROM reservations r WHERE r.transitLine = '"+ entity +"';";
