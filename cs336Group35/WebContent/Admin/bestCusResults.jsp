...
<body>
	...
	<%
		...
		try {
			...
			String str = "SELECT r.username as \"Best Customer\" FROM reservations r GROUP BY r.username order by count(*) desc limit 1;";
			...
			out.print("Best Customer's Username");
			out.print("</td>");
			...
			while (result.next()) {
				...
				out.print(result.getString("Best Customer"));
				out.print("</td>");
