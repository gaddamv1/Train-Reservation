...
<title>List of Rev by Cust Results</title>
</head>
<body>
	...
	<%
		...
		try {
			...
			String entity = request.getParameter("tLinecRev");
			String entity2 = request.getParameter("tLinec2Rev");
			//Make a SELECT query from the sells table with the price range specified by the 'price' parameter at the index.jsp
			String str = "SELECT r.reservationNum, r.resDate, r.totalFare FROM reservations r, customers c WHERE r.username = c.username and c.firstname = '"+ entity +"' and c.lastname = '"+ entity2 +"';";
