...
<html>
	<head>
		...
		<title>Result of Edited Train Schedule</title>
	</head>
	<body>
		<% try {
			...
			if (numb == true) {
				...
				String update = "UPDATE trainSchedules SET "+ columnName +" = " + newValue2 + " WHERE schID = " + scheduleID;
				...
				try{
				String update = "UPDATE trainSchedules SET "+ columnName +" = \"" + newValue + "\" WHERE schID = " + scheduleID;
				stmt.executeUpdate(update);
				}catch (Exception e) {
					out.print(e);
				}
