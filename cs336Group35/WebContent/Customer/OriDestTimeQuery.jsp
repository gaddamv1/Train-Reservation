...
<title>By Origin, Destination, and Departure</title>
</head>
<body>
	<%
		...
		try {
			...
			String entity = request.getParameter("origin");
			String entity2 = request.getParameter("destination");
			String entity3 = request.getParameter("departure");
			...
			"and o.stationID =  " + entity + " " +
			"and d.stationID = " + entity2 + " " +
			"and t.departure = " + "'" + entity3 + "'";
